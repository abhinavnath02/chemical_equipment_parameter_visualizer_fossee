      ...
      <main className="relative z-10 container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              href="/ChemicalEquipmentVisualizer.exe"
              download="ChemicalEquipmentVisualizer.exe"
              className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all hover:scale-105 shadow-lg flex items-center gap-2"
            >
